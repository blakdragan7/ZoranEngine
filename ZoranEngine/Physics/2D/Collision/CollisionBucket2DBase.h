...
class CollisionBucket2DBase : public CollisionBucketBase
{
protected:
...
public:
	...
	virtual bool CheckObjectAgainstStaic(CollisionObject2DBase* object, struct CollisionResponse2D& response) = 0;
	virtual bool CheckCollisionForObject(CollisionObject2DBase* object, struct CollisionResponse2D& response) = 0;
	virtual bool SweepCollision(CollisionObject2DBase* object, Vec2D newPosition, struct SweepCollisionResponse2D& response) = 0;
	virtual bool SweepCollisionHitTest(CollisionObject2DBase* object, Vec2D newPosition, struct SweepCollisionResponse2D& response) = 0;

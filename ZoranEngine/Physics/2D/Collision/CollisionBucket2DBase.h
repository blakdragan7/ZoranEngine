...
public:
	...
	virtual bool CheckObjectAgainstStaic(CollisionObject2DBase* object, struct Collision2D& response) = 0;
	virtual bool CheckCollisionForObject(CollisionObject2DBase* object, struct Collision2D& response) = 0;

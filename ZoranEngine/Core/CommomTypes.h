...
constexpr unsigned Key_BackSpace = 0x08;
constexpr unsigned Key_Delete = 0x2E;
constexpr unsigned Key_PrintScreen = 0x2C;
constexpr unsigned Key_Insert = 0x2D;
constexpr unsigned Key_CapsLock = 0x14;

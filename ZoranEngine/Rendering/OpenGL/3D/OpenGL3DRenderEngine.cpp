...
TextureBase* OpenGL3DRenderEngine::CreateTexture(const char* path, RenderDataType bufferType, RenderDataFormat bufferFormat, int* error)
{
	if (context)
...
FontRenderer * OpenGL3DRenderEngine::CreateFontRenderer(FontResource font)
{
